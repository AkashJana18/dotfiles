return {
  ...
  -- To switch back to catppuccin, comment out the gruvbox blocks below and
  -- uncomment the "PREVIOUS THEME: catppuccin" blocks at the bottom.
  -- ============================================================================
  ...
  -- ============================================================================
  -- PREVIOUS THEME: catppuccin (commented out)
  -- Uncomment the blocks below and comment out the gruvbox blocks above
